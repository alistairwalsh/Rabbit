...
void setup() {
  ...
  arduino = new Arduino(this, Arduino.list()[9], 115200);
  ...
  for (int i=0;i<scopes.length;i++){
    ...
    controlP5.addButton("pause"+i,1,dimv[0]+10,posv[1]+10,32,20).setId(i);
    controlP5.addButton("logic"+(i+50),1,dimv[0]+52,posv[1]+10,29,20).setId(i+50);
    controlP5.addButton("save"+(i+100),1,dimv[0]+92,posv[1]+10,29,20).setId(i+100);
  }
